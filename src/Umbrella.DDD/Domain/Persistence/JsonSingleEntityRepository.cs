...
{
    /// <summary>
    /// Base implementation for Domain Entity repository, where persistence is on filesystem through json files, one per entity
    /// </summary>
    /// <typeparam name="T">type of Business Entity</typeparam>
    /// <typeparam name="Tdto">type of DTO taht maps the entity</typeparam>
    public abstract class JsonSingleEntityRepository<T, Tdto> : IEntityRepository<T>
        ...
        where Tdto : class, IEntityDto
    {
        ...
        protected JsonSingleEntityRepository(string path, string filename)
        {
